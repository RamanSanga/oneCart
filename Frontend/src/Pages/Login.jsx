  ...
  return (
    <div className="min-h-screen flex bg-[var(--cream)] text-[var(--ink)]">
      ...
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
        <img src="https://images.unsplash.com/photo-1509631179647-0177331693ae?q=80&w=1000&auto=format&fit=crop" alt="OneCart editorial" className="w-full h-full object-cover" />
